...
faucet = subprocess.check_output("curl -s -X POST \"https://regtest-2.alexgo.io/extended/v1/faucets/stx?address=$(cat ./deploy-keychain.json | jq -r .keyInfo.address)\" | jq .", shell=True)
